...
- **Generación de Credenciales**: Auto-crea `.env` con templates de endpoints Azure
...
- Genera archivo `.env` con templates de credenciales
- **Output**: `.env` listo para que el usuario rellene credenciales
